# Upgrade Hikvision NVR via Web Portal
...
2. Extract the Zip File
  * You may find a `digicap.dav`

3. Upgrade NVR
  * Login to NVR Web Portal
  * Go to Preferences > System > System Mantainence > Upgrade
  * Select `digicap.dav`
  * Click "Upgrade" button
  * It'll reboot after the upgrade is done(about 5 - 10 minutes)
